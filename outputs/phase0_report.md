...
Generated: 2026-09-22 18:30 · input: `C:\Users\EKutlu\Desktop\RAG\politics\data\original` · config: `config.yaml`  
...
|---|---|---|---|---|---|---|---|---|---|
| Recep Tayyip Erdoğan | tr | 5 | 5 | 0 | 3251 | 650 | 85 | tr×5 | OK |
| Emmanuel Macron | fr | 4 | 4 | 0 | 7502 | 1876 | 99 | fr×4 | OK |
| Angela Merkel | de | 4 | 4 | 0 | 3307 | 827 | 46 | de×4 | OK |
| Vladimir Putin | en | 4 | 4 | 0 | 2517 | 629 | 27 | en×4 | OK |
| Donald Trump | en | 3 | 3 | 0 | 4721 | 1574 | 50 | en×3 | OK |

Total: **20 files**, 20 with text, 0 empty · **21,298 words** · **307 estimated chunks**.
...
|---|---|---|---|---|---|---|---|---|
| erdogan | erdogan1.txt | 574 | 25 | 1360 | 13 | tr |  | symposium_speech |
| erdogan | erdogan2022.txt | 684 | 52 | 1905 | 18 | tr | 2022-12-31 | new_year_message |
| erdogan | erdogan2023.txt | 689 | 50 | 1915 | 19 | tr | 2023-12-31 | new_year_message |
| erdogan | erdogan2024.txt | 578 | 41 | 1612 | 16 | tr | 2024-12-31 | new_year_message |
| erdogan | erdogan2025.txt | 726 | 45 | 1978 | 19 | tr | 2025-12-31 | new_year_message |
| macron | macron2022.txt | 2811 | 50 | 4720 | 35 | fr | 2022-12-31 | new_year_address |
| macron | macron2023.txt | 1824 | 33 | 3121 | 25 | fr | 2023-12-31 | new_year_address |
| macron | macron2024.txt | 1495 | 43 | 2516 | 22 | fr | 2024-12-31 | new_year_address |
| macron | macron2025.txt | 1372 | 20 | 2323 | 17 | fr | 2025-12-31 | new_year_address |
| merkel | merkel1.txt | 870 | 28 | 1483 | 12 | de | 2016-12-31 | new_year_address |
| merkel | merkel2.txt | 803 | 19 | 1332 | 11 | de | 2017-12-31 | new_year_address |
| merkel | merkel2020.txt | 862 | 17 | 1466 | 12 | de | 2019-12-31 | new_year_address |
| merkel | merkel3.txt | 772 | 20 | 1332 | 11 | de | 2018-12-31 | new_year_address |
...
| erdogan1.txt | erdogan | review:verify | Not a New Year message: a speech at a SETA symposium held 'on the eve of the historic decision' on the presidential system (likely early 2017, before the April  |
...
| macron2022.txt | macron | excess_whitespace | 152 runs of multiple spaces (copy/paste or PDF artifact) |
...
| trump2.txt | trump | review:exclude_candidate | NOT a single speech: ~320 words stitched from several occasions (Gorsuch nomination Jan 2017, MS-13 remarks, a disaster-visit remark 'your governor has done a f |
...
| trump3.txt | trump | review:verify | Closing lines match the 2017 inaugural ('make America strong again ... wealthy ... proud ... safe ... great again'). The first ~120 words are the oath ceremony: |

Flag counts: `missing_metadata`×20, `speaker_label_prefix`×3, `mixed_speech_types`×3, `review:verify`×2, `speech_type_outlier`×1, `excess_whitespace`×1, `filename_year_vs_speech_date`×1, `truncated_start`×1, `very_short`×1, `review:exclude_candidate`×1
...
|---|---|---|---|---|---|---|
| erdogan | erdogan1.txt | 25 | 1360 | 13 | 1 | 104.6 |
| erdogan | erdogan2022.txt | 52 | 1905 | 18 | 0 | 105.8 |
| erdogan | erdogan2023.txt | 50 | 1915 | 19 | 0 | 100.8 |
| erdogan | erdogan2024.txt | 41 | 1612 | 16 | 0 | 100.8 |
| erdogan | erdogan2025.txt | 45 | 1978 | 19 | 0 | 104.1 |
| macron | macron2022.txt | 50 | 4720 | 35 | 2 | 134.9 |
| macron | macron2023.txt | 33 | 3121 | 25 | 0 | 124.8 |
| macron | macron2024.txt | 43 | 2516 | 22 | 0 | 114.4 |
| macron | macron2025.txt | 20 | 2323 | 17 | 2 | 136.6 |
| merkel | merkel1.txt | 28 | 1483 | 12 | 0 | 123.6 |
| merkel | merkel2.txt | 19 | 1332 | 11 | 0 | 121.1 |
| merkel | merkel2020.txt | 17 | 1466 | 12 | 0 | 122.2 |
| merkel | merkel3.txt | 20 | 1332 | 11 | 0 | 121.1 |
...
Chunks per leader: Erdoğan 85, Macron 99, Merkel 46, Putin 27, Trump 50
...
- **`erdogan1.txt`** — `verify`: Not a New Year message: a speech at a SETA symposium held 'on the eve of the historic decision' on the presidential system (likely early 2017, before the April 2017 referendum). Text looks like an automatic speech-to-text transcript (e.g. '200 yü yılda', 'odaklanacak lardır'). Confirm date/source and whether to keep a different speech type in the corpus.
- **`trump2.txt`** — `exclude_candidate`: NOT a single speech: ~320 words stitched from several occasions (Gorsuch nomination Jan 2017, MS-13 remarks, a disaster-visit remark 'your governor has done a fantastic job', space-policy lines 'the sky is never the limit'). Recommend replacing with one complete speech or excluding; a composite would distort speech-level aggregation.
- **`trump3.txt`** — `verify`: Closing lines match the 2017 inaugural ('make America strong again ... wealthy ... proud ... safe ... great again'). The first ~120 words are the oath ceremony: an announcer introducing Chief Justice Roberts and the oath repeated line by line. Those lines are not the leader's own speech and should be removed in Phase 1 (logged).
